create table caracteristique (id bigint not null auto_increment, attaque integer not null, defense integer not null, dribble integer not null, hauteur integer not null, pass integer not null, physique integer not null, piedfort varchar(255), poids double, position varchar(255), precisio varchar(255), tir integer not null, vitesse integer not null, primary key (id)) engine=InnoDB;
create table detailpartie (parties_id bigint not null, joueurs_id bigint not null) engine=InnoDB;
create table joueur (id bigint not null auto_increment, adresse varchar(255), disponibilite bit not null, nationalite varchar(255), nom varchar(255), password varchar(255), prenom varchar(255), caracteristique_id bigint, scout_id bigint, primary key (id)) engine=InnoDB;
