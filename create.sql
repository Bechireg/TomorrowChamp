...
create table joueur (id integer not null auto_increment, adresse varchar(255), disponibilite bit not null, email varchar(255), nationalite varchar(255), nom varchar(255), prenom varchar(255), primary key (id)) engine=InnoDB
